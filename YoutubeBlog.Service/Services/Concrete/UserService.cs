...
namespace YoutubeBlog.Service.Services.Concrete
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUnitOfWork unitOfWork, UserManager<AppUser> userManager, IMapper mapper, RoleManager<AppRole> roleManager, IHttpContextAccessor httpContextAccessor, ClaimsPrincipal user,SignInManager<AppUser> signInManager,IImageHelper ımageHelper)
        {
        ...
        public async Task<List<UserDto>> GetListAllUserWithRoleAsync()
        {
